...
ALLSPHINXOPTS    = -d $(BUILDDIR)/doctrees $(PAPEROPT_$(PAPER_FR)) $(SPHINXOPTS) source
ALLSPHINXOPTS_EN = -d $(BUILDDIR)/doctrees $(PAPEROPT_$(PAPER_EN)) $(SPHINXOPTS) source-en
...
help:
	...
	@echo "  latexpdf      to make LaTeX files and run them through pdflatex (French)"
	@echo "  latexpdf-en   to make LaTeX files and run them through pdflatex (English)"
...
singlehtml-en:
	-mkdir -p $(BUILDDIR)/singlehtml-en
	$(SPHINXBUILD) -b singlehtml-en $(ALLSPHINXOPTS_EN) $(BUILDDIR)/singlehtml-en
	@echo
